...
// ROOT is now __dirname since index.html, assets, lang, maps are all in the same folder
...
app.post("/players", (req, res) => {
  try {
    ...
    // ROOT is __dirname, world live folder is at maps/world/live/
    ...
    console.log("✔ players.json updated at maps/world/live/players.json");
